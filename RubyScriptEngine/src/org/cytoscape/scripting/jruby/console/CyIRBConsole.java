 ...
 */
package org.cytoscape.scripting.jruby.console;
...
import org.cytoscape.scripting.jruby.RubyScriptEnginePlugin;
...
public class CyIRBConsole extends JPanel {
	...
	private static final ImageIcon tabIcon = new ImageIcon(
			RubyScriptEnginePlugin.class.getResource("/images/ruby22x22.png"));
	...
	public CyIRBConsole() throws IOException {
		...
		if (scriptLocation == null) {
			scriptURL = RubyScriptEnginePlugin.class
	...
	public static void showConsole() throws IOException, ScriptException {
		if (console == null) {
			...
			if (runtime == null) {
				...
				final String rubyHome = RubyScriptEnginePlugin.getJRubyHome();
				if (rubyHome == null)
			...
			Cytoscape
					...
					.add("BioRuby Console (Powered by JRuby "
							+ RubyScriptEnginePlugin.getEngineVersion() + ")",
							tabIcon, console);
